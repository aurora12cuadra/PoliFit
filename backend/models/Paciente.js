...
const Paciente = sequelize.define('Paciente', {
    ...
    sexo: { type: DataTypes.STRING(60), allowNull: false },
    estadoCivil: { type: DataTypes.STRING(60), allowNull: false },
    ocupacion: { type: DataTypes.STRING(60), allowNull: false },
    telefono: { type: DataTypes.STRING(20), allowNull: false },
    email: { type: DataTypes.STRING(100), allowNull: false },
    escuela: { type: DataTypes.STRING(60), allowNull: false },
    carrera: { type: DataTypes.STRING(100), allowNull: false },
    domicilio: { type: DataTypes.STRING(60), allowNull: false },
